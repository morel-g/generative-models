...
**Note**: The models have not been trained extensively in order to save computational power. However, training them for longer durations should improve the results. See the configuration files from the original papers if needed.
