# Modification of https://github.com/huggingface/diffusers/blob/v0.20.2/src/diffusers/models/unet_1d.py
# to deal with the time variable in the same way as the ncspp architecture
...
class UNet1DModel(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        if time_embedding_type == "fourier":
            ...
            timestep_input_dim = 2 * embedding_size  # block_out_channels[0]
        ...
        if use_timestep_embedding:
            ...
            # Modif compare to the original file
